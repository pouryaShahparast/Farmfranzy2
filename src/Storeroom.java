...
public class Storeroom {
    ...
    int spaceTaken;
    HashSet<Commodity> commodityHashSet;
    HashSet<WildAnimal> wildAnimalHashSet;
    ...
    public boolean storeWildAnimal(WildAnimal wildAnimal){
    ...
    public boolean storeFinalCommodity(FinalCommodity finalCommodity){
    ...
    public boolean storeIntermediaryCommodity(IntermediaryCommodity intermediaryCommodity){
    ...
    public boolean storePrimitiveCommodity(PrimitiveCommodity primitiveCommodity){
